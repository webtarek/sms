...
<p>
    <a href="http://cakephp.org/changelogs/<?php echo Configure::version(); ?>"><?php echo __d(
            'cake_dev',
            'Read the changelog'
        ); ?> </a>
</p>
...
<p>
    ...
    if (!empty($settings)):
        ...
        echo __d(
            'cake_dev',
            'The %s is being used for core caching. To change the config edit %s',
...
<ul>
    ...
    <li><a href="https://github.com/cakephp/cakephp/wiki#roadmaps"><?php echo __d(
                'cake_dev',
                'CakePHP Roadmaps'
            ); ?> </a>
        <ul>
